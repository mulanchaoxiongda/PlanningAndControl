...
{
    //TrajPoint trajectory_point = {0.0, 0.0, 0.0/57.3, 0.5, 0.0, 0.0}; // x, y, yaw, v, w, t
    TrajPoint trajectory_point =
                {0.0, 0.0, 0.0/57.3, 0.5*0.15*2.5*2.5, 0.0, 0.0}; // x, y, yaw, v, w, t
    ...
    while (trajectory_point.t_ref <= 2.5) {
