...
RobotMotionStatePara RobotModel::UpdateMotionState(
        ControlCommand control_command)
{
    ...
    if (model_type == 0) {
        motion_state_.v = control_command.SpeedCommand;
        motion_state_.w = control_command.YawRateCommand;
        
        motion_state_.yaw =
                motion_state_.yaw + motion_state_.w * simulation_step_;
        ...
        double acceleration =
                (control_command.SpeedCommand - motion_state_.v) / Tv;
                                                                                
        double yaw_acceleration =
                (control_command.YawRateCommand - motion_state_.w) / Tw;
